...
def get_best_match(segmented, alignments, LEN, max_segment_length=None, threshold=0.8): # threshold for best_match to exist
    ...
    for currlen in range(1, max_segment_length + 1):
        for start_index in range(0, LEN - currlen + 1):
            ...
            if result and result["score"] > best_score and result["score"] >= threshold:
